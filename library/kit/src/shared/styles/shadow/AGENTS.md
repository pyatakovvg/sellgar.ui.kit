...
Путь: `src/shared/styles/shadow`

## Что это

Структурный каталог `shadow`, который задает границу ответственности для дочерних узлов.

## Назначение

Структурный узел shadow, группирующий дочерние компоненты одного уровня ответственности.
