...
Путь: `src/core/systems/floating/dropdown/empty`.

## Что это

`Empty` — компонент в срезе `core/systems/floating`.
...
- Public/local entrypoint: `src/core/systems/floating/dropdown/empty/index.ts`.
- Source: `src/core/systems/floating/dropdown/empty/empty.tsx`.
