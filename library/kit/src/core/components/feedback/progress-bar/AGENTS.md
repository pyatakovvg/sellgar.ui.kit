...
Путь: `src/core/components/feedback/progress-bar`.

## Что это

`ProgressBar` — компонент в срезе `core/components`.

## Назначение

Feedback primitive для линейного progress state.
...
- Public/local entrypoint: `src/core/components/feedback/progress-bar/index.ts`.
- Source: `src/core/components/feedback/progress-bar/progress-bar.tsx`.
...
- Storybook scenario: `../../clients/storybook/src/kit/symbols/progress-bar/progress-bar.stories.tsx`.
