...
Путь: `src/core/components/controls/datepicker/placeholder`.
...
- Public/local entrypoint: `src/core/components/controls/datepicker/placeholder/index.ts`.
- Source: `src/core/components/controls/datepicker/placeholder/placeholder.tsx`.
...
- Parent Storybook scenario: `../../clients/storybook/src/kit/symbols/datepicker/datepicker.stories.tsx`. Проверять изменение через parent-сценарий, потому что отдельной story для scoped/internal части нет.
