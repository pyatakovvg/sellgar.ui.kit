...
Путь: `src/core/components/controls/datepicker/option`.
...
- Public/local entrypoint: `src/core/components/controls/datepicker/option/index.ts`.
- Source: `src/core/components/controls/datepicker/option/option.tsx`.
