...
Путь: `src/core/components/controls/field`.

## Что это

`Field` — компонент в срезе `core/components`.

## Назначение

Form layout composition с compound slots Label, Content и Caption.
...
- Public/local entrypoint: `src/core/components/controls/field/index.ts`.
- Source: `src/core/components/controls/field/field.wrapper.tsx`.
...
- Storybook scenario: `../../clients/storybook/src/kit/wrappers/field/field.stories.tsx`.
