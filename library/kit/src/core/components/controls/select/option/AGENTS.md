...
Путь: `src/core/components/controls/select/option`.
...
- Public/local entrypoint: `src/core/components/controls/select/option/index.ts`.
- Source: `src/core/components/controls/select/option/option.tsx`.
