...
Путь: `src/core/components/controls/select/placeholder`.
...
- Public/local entrypoint: `src/core/components/controls/select/placeholder/index.ts`.
- Source: `src/core/components/controls/select/placeholder/placeholder.tsx`.
...
- Parent Storybook scenario: `../../clients/storybook/src/kit/symbols/select/select.stories.tsx`. Проверять изменение через parent-сценарий, потому что отдельной story для scoped/internal части нет.
