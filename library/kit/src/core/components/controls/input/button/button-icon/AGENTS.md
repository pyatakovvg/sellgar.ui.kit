...
Путь: `src/core/components/controls/input/button/button-icon`.
...
- Public/local entrypoint: `src/core/components/controls/input/button/button-icon/index.ts`.
- Source: `src/core/components/controls/input/button/button-icon/button-icon.tsx`.
...
- Props из `IProps`: `size`, `leadIcon`, `inProcess`.
- Локальных parts нет.
...
- Props contract: `size`, `leadIcon`, `inProcess`. Новые/изменённые props нужно отражать в story и документации.
